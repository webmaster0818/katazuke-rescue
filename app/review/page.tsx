...
export const metadata: Metadata = {
  title: "不用品回収・遺品整理・片付け業者の口コミ・評判まとめ｜実際のGoogleレビューで検証",
  description: "不用品回収・遺品整理・片付けの業者や比較サービスを、実際のGoogle口コミと運営会社の公開情報で中立的に検証します。",
  alternates: { canonical: "https://katazuke-rescue.com/review/" },
};
...
export default function ReviewIndex() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <h1 className="text-2xl sm:text-3xl font-bold text-text-primary mt-2 mb-4">不用品回収・遺品整理・片付け業者の口コミ・評判まとめ</h1>
      <p className="text-[15px] leading-8 text-text-secondary mb-8">
        実際にGoogleマップへ投稿された口コミと、各社の公開情報をもとに、不用品回収・遺品整理・片付けの業者や比較サービスを中立的に検証します。掲載しているのはすべて実在のレビューまたは公式の利用者の声です。
      </p>
